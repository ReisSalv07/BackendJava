...
public class DisciplinaController {
    ...
    public List<Disciplina> listarTodosAlunos() {
    ...
    @PutMapping("/{id}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void atualizarDisciplinaPorId(@PathVariable Long id, @RequestBody Disciplina disciplinaEditado ) {
        disciplinaService.atualizarDisciplinaPorId(id, disciplinaEditado);
    }
